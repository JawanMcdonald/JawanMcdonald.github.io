    ...
    window.opspark.runLevelInGame = function(game) {
        ...
        var levelData = {
            ...
            gameItems: [
                ...
                {type: 'enemy',x:1730,y:groundY-50},
                {type: 'enemy',x:1090,y:groundY-50},
                {type: 'reward',x:2300,y:groundY-138},
                {type: 'reward',x:3429,y:groundY - 138},
                {type: 'reward',x:1910,y:groundY - 138}
            ]
        };
